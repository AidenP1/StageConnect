...
function EtudiantStages() {
  ...
  const handlePostuler = async () => {
    ...
    try {
      await postuler(modalPostuler.id, lettreMotivation);
  ...
  return (
    <div className="dashboard-layout">
      ...
      <div className="dashboard-content">
        ...
        {/* modal postuler */}
        {modalPostuler && (
          <div className="modal-overlay" onClick={() => setModalPostuler(null)}>
            <div className="modal-box card-custom" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="d-flex gap-2 justify-content-end">
                <button className="btn btn-outline-secondary" onClick={() => setModalPostuler(null)}>
                  {t('common.cancel')}
                </button>
